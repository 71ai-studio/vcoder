...
- PR #10809: https://github.com/anomalyco/vcoder/pull/10809
- PR #11496: https://github.com/anomalyco/vcoder/pull/11496

## Do Not Translate (Locale Additions)

- `Vcoder` (preserve casing in prose; keep `vcoder` only in commands, package names, paths, or code)
- `Vcoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
