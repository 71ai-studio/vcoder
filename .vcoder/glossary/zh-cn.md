...
- PR #13942: https://github.com/anomalyco/vcoder/pull/13942

## Do Not Translate (Locale Additions)

- `Vcoder` (preserve casing in prose; keep `vcoder` only when it is part of commands, package names, paths, or code)
- `Vcoder Zen`
- `Vcoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `vcoder` in prose when referring to the product name; use `Vcoder`
