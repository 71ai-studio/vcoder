...
Use this folder for locale-specific translation guidance that supplements `.vcoder/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/vcoder/pull/12345

## Do Not Translate (Locale Additions)

- `Vcoder` (preserve casing)
