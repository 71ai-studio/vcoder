...
- PR #15835: https://github.com/anomalyco/vcoder/pull/15835

## Do Not Translate (Locale Additions)

- `Vcoder` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `vcoder` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Vcoder` in prose, `vcoder` only for exact technical identifiers
...
- Avoid changing `vcoder` to `Vcoder` inside commands, URLs, package names, or code literals
