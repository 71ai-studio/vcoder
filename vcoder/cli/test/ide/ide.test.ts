...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders VCODER_CALLER", () => {
    process.env["VCODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode VCODER_CALLER", () => {
    process.env["VCODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown VCODER_CALLER", () => {
    process.env["VCODER_CALLER"] = "unknown"
