...
const originalHttpApi = Flag.VCODER_EXPERIMENTAL_HTTPAPI
const originalWorkspaces = Flag.VCODER_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.VCODER_EXPERIMENTAL_HTTPAPI = originalHttpApi
  Flag.VCODER_EXPERIMENTAL_WORKSPACES = originalWorkspaces
