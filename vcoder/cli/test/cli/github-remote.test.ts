...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/vcoder.git")).toEqual({ owner: "sst", repo: "vcoder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/vcoder")).toEqual({ owner: "sst", repo: "vcoder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/vcoder.git")).toEqual({ owner: "sst", repo: "vcoder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/vcoder")).toEqual({ owner: "sst", repo: "vcoder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/vcoder.git")).toEqual({ owner: "sst", repo: "vcoder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/vcoder")).toEqual({ owner: "sst", repo: "vcoder" })
})
