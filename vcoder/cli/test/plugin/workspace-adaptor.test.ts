...
const { Flag } = await import("@vcoder/core/flag/flag")
const { Plugin } = await import("../../src/plugin/index")
const { Workspace } = await import("../../src/control-plane/workspace")
const { Instance } = await import("../../src/project/instance")

const experimental = Flag.VCODER_EXPERIMENTAL_WORKSPACES

Flag.VCODER_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.VCODER_EXPERIMENTAL_WORKSPACES = experimental
})
