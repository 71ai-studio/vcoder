...
import { sanitizedProcessEnv } from "@vcoder/core/util/vcoder-process"
...
export class Service extends Context.Service<Service, Interface>()("@vcoder/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".vcoder")) continue
