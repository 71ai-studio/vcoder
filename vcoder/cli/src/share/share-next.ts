import type * as SDK from "@vcoder/sdk/v2"
...
const disabled = process.env["VCODER_DISABLE_SHARE"] === "true" || process.env["VCODER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@vcoder/ShareNext") {}
