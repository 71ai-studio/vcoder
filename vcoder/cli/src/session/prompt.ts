...
import * as EffectLogger from "@vcoder/core/effect/logger"
...
export class Service extends Context.Service<Service, Interface>()("@vcoder/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.VCODER_EXPERIMENTAL_PLAN_MODE) {
