...
Practical reference for the current tool-migration state in `packages/vcoder`.
...
Tool tests should use the existing Effect helpers in `packages/vcoder/test/lib/effect.ts`:
