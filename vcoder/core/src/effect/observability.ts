...
import { ensureProcessMetadata } from "../util/vcoder-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "vcoder.client": Flag.VCODER_CLIENT,
      "vcoder.process_role": processMetadata.processRole,
      "vcoder.run_id": processMetadata.runID,
